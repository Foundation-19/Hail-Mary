...
/obj/structure/newchalkboard/verb/honk()
	set src in oview(1)
	set name = "Draw"
...
/obj/structure/newchalkboard/verb/wrtite()
	set src in oview(1)
	set name = "Write"
...
/obj/structure/newchalkboard/verb/cleanup()
	set src in oview(1)
	set name = "Cleanup"
...
/obj/structure/newchalkboard/proc/update()
	...
	switch (status)
		...
		if(CB_CONTENT)
			...
			desc +=	content
			desc += "<HR>"
			icon_state = "newboard_text[rand(1, 9)]"
		...
		if(CB_MESS)
			...
			icon_state = "newboard_mess[rand(1, 6)]"
			content = "Draw"

/obj/structure/newchalkboard/proc/parsepencode(t)
