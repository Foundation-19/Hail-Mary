...
/obj/structure/shopping_cart
	name = "shopping cart"
	icon_state = "cart"
	icon = 'fallout/icons/objects/cart.dmi'
...
/obj/structure/sign/crosswalk
	...
	icon = 'fallout/icons/objects/signs_small.dmi'
...
/obj/structure/playground/slide
	...
	icon = 'fallout/icons/objects/playground64x32.dmi'
	icon_state = "slide"
...
/obj/structure/playground/tireswing
	name = "Tire swing"
	desc = "Swing Low."
	icon = 'fallout/icons/objects/playground100x100.dmi'
...
/obj/structure/rug/carpet
	...
	icon = 'fallout/icons/objects/run_carpets.dmi'
	icon_state = "carpet"
