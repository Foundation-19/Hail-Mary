...
/obj/structure/flora/tree/oak_one
	name = "tree"
	desc = "woody"
	icon = 'fallout/icons/objects/flora.dmi'
	icon_state = "tree_1"
	anchored = TRUE
...
/obj/structure/flora/tree/chomp/palmtreeb
	name = "palm tree"
	desc = "woody"
	icon = 'fallout/icons/objects/desert_planet_160x160.dmi'
...
/obj/structure/flora/chomp/palmstump3
	name = "palm stump"
	desc = "kinda stumpy"
	icon = 'fallout/icons/objects/desert_plant.dmi'
...
/obj/structure/flora/chomp/palmuria
	name = "palmuria"
	icon = 'fallout/icons/objects/desert_props_64x64.dmi'
	icon_state = "palmuria"
	anchored = TRUE
