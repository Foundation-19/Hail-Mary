GLOBAL_LIST_INIT(loadout_categories, list(
	...
	LOADOUT_CATEGORY_HANDS = list(LOADOUT_SUBCATEGORY_HANDS_GENERAL, LOADOUT_SUBCATEGORY_HANDS_SHIELDS, LOADOUT_SUBCATEGORY_HANDS_MODKITS),
	LOADOUT_CATEGORY_UNIFORM = list(LOADOUT_SUBCATEGORY_UNIFORM_GENERAL, LOADOUT_SUBCATEGORY_UNIFORM_WASTELAND, LOADOUT_SUBCATEGORY_UNIFORM_SUITS, LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS, LOADOUT_SUBCATEGORY_UNIFORM_DRESSES, LOADOUT_SUBCATEGORY_UNIFORM_SWEATERS, LOADOUT_SUBCATEGORY_UNIFORM_PANTS, LOADOUT_SUBCATEGORY_UNIFORM_TRADITIONAL, LOADOUT_SUBCATEGORY_UNIFORM_RAIDER, LOADOUT_SUBCATEGORY_UNIFORM_UNIFORMS, LOADOUT_SUBCATEGORY_UNIFORM_JUMPSUITS, LOADOUT_SUBCATEGORY_UNIFORM_ESCORT, LOADOUT_SUBCATEGORY_UNIFORM_TRIBAL),
	LOADOUT_CATEGORY_SUIT = list(LOADOUT_SUBCATEGORY_SUIT_GENERAL, LOADOUT_SUBCATEGORY_SUIT_ARMOR, LOADOUT_SUBCATEGORY_SUIT_JACKETS),
	LOADOUT_CATEGORY_BELT = LOADOUT_SUBCATEGORIES_NONE,
	LOADOUT_CATEGORY_HEAD = list(LOADOUT_SUBCATEGORY_HEAD_GENERAL, /*LOADOUT_SUBCATEGORY_HEAD_COWBOY, LOADOUT_SUBCATEGORY_HEAD_HELMETS, */LOADOUT_SUBCATEGORY_HEAD_FACTIONS),
