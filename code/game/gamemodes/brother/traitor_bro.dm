...
TYPE_PROC_REF(/datum/game_mode, update_brother_icons_added)(datum/mind/brother_mind)
...
TYPE_PROC_REF(/datum/game_mode, update_brother_icons_removed)(datum/mind/brother_mind)
	var/datum/atom_hud/antag/brotherhud = GLOB.huds[ANTAG_HUD_BROTHER]
