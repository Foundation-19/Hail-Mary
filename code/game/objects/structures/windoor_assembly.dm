...
TYPE_PROC_REF(/obj/structure/windoor_assembly, can_be_rotated)(mob/user,rotation_type)
	if(anchored)
...
TYPE_PROC_REF(/obj/structure/windoor_assembly, after_rotation)(mob/user)
	ini_dir = dir
	update_icon()
