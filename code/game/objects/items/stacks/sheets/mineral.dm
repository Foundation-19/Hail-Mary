...
//	new/datum/stack_recipe("diamond brick", /obj/item/blacksmith/ingot/diamond, 6, time = 100), \ not yet
	))
...
//	new/datum/stack_recipe("plasma ingot", /obj/item/blacksmith/ingot/plasma, 6, time = 100), \ no
	))
