...
/obj/item/book/granter/trait/explosives
	...
	crafting_recipe_types = list(/datum/crafting_recipe/frag_shrapnel, /datum/crafting_recipe/stinger, /datum/crafting_recipe/flashbang, /datum/crafting_recipe/smokebomb, /datum/crafting_recipe/explosive/shrapnelmine, /datum/crafting_recipe/explosive/stingmine, /datum/crafting_recipe/explosive/stunmine, /datum/crafting_recipe/rocket_base, /datum/crafting_recipe/weakrocket)
...
/obj/item/book/granter/trait/explosives_advanced
	...
	crafting_recipe_types = list(/datum/crafting_recipe/incendiary, /datum/crafting_recipe/concussion, /datum/crafting_recipe/radgrenade, /datum/crafting_recipe/empgrenade, /datum/crafting_recipe/incendiaryrocket, /datum/crafting_recipe/strongrocket, /datum/crafting_recipe/frag_shrapnel, /datum/crafting_recipe/stinger, /datum/crafting_recipe/flashbang, /datum/crafting_recipe/smokebomb, /datum/crafting_recipe/explosive/shrapnelmine, /datum/crafting_recipe/explosive/stingmine, /datum/crafting_recipe/explosive/stunmine, /datum/crafting_recipe/explosive/pulsemine, /datum/crafting_recipe/explosive/explomine, /datum/crafting_recipe/rocket_base, /datum/crafting_recipe/weakrocket)
