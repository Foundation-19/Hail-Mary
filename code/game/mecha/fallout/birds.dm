...
/obj/mecha/base_vehicle/vertibird/GrantActions(mob/living/user, human_occupant = 0)
...
/obj/mecha/base_vehicle/vertibird/RemoveActions(mob/living/user, human_occupant = 0)
...
/obj/mecha/base_vehicle/vertibird/obj_destruction()
...
/obj/mecha/base_vehicle/vertibird/proc/go_critical()
	explosion(get_turf(loc))
	Destroy(src)

/obj/mecha/base_vehicle/vertibird/loaded/Initialize()
	. = ..()
...
/obj/mecha/base_vehicle/vertibird/ncr
...
/obj/mecha/base_vehicle/vertibird/ncr/GrantActions(mob/living/user, human_occupant = 0)
	internals_action.Grant(user, src)
	cycle_action.Grant(user, src)
	lights_action.Grant(user, src)
	stats_action.Grant(user, src)
...
/obj/mecha/base_vehicle/vertibird/ncr/RemoveActions(mob/living/user, human_occupant = 0)
	internals_action.Remove(user)
	cycle_action.Remove(user)
	lights_action.Remove(user)
	stats_action.Remove(user)
...
/obj/mecha/base_vehicle/vertibird/ncr/loaded/Initialize()
	. = ..()
	var/obj/item/mecha_parts/mecha_equipment/ME = new /obj/item/mecha_parts/mecha_equipment/weapon/ballistic/lmg/rapid
	ME.attach(src)
	ME = new /obj/item/mecha_parts/mecha_equipment/seat
...
/obj/mecha/base_vehicle/vertibird/enclave
...
/obj/mecha/base_vehicle/vertibird/enclave/GrantActions(mob/living/user, human_occupant = 0)
	internals_action.Grant(user, src)
	cycle_action.Grant(user, src)
	lights_action.Grant(user, src)
	stats_action.Grant(user, src)
...
/obj/mecha/base_vehicle/vertibird/enclave/RemoveActions(mob/living/user, human_occupant = 0)
	internals_action.Remove(user)
	cycle_action.Remove(user)
	lights_action.Remove(user)
	stats_action.Remove(user)
...
/obj/mecha/base_vehicle/vertibird/enclave/obj_destruction()
	for(var/mob/M in src)
		to_chat(M, span_brass(" The vertibird is going to Crash !"))
		M.dust()
	playsound(src, 'sound//f13machines//vertibird_crash.ogg', 100, 0)
...
/obj/mecha/base_vehicle/vertibird/enclave/loaded/Initialize()
	. = ..()
	var/obj/item/mecha_parts/mecha_equipment/ME = new /obj/item/mecha_parts/mecha_equipment/weapon/ballistic/lmg/rapid
	ME.attach(src)
	ME = new /obj/item/mecha_parts/mecha_equipment/seat
...
/obj/mecha/base_vehicle/vertibird/brotherhood
...
/obj/mecha/base_vehicle/vertibird/brotherhood/GrantActions(mob/living/user, human_occupant = 0)
	internals_action.Grant(user, src)
	cycle_action.Grant(user, src)
	lights_action.Grant(user, src)
	stats_action.Grant(user, src)
...
/obj/mecha/base_vehicle/vertibird/brotherhood/RemoveActions(mob/living/user, human_occupant = 0)
	internals_action.Remove(user)
	cycle_action.Remove(user)
	lights_action.Remove(user)
	stats_action.Remove(user)
...
/obj/mecha/base_vehicle/vertibird/brotherhood/obj_destruction()
	for(var/mob/M in src)
		to_chat(M, span_brass(" The vertibird is going to Crash !"))
		M.dust()
	playsound(src, 'sound//f13machines//vertibird_crash.ogg', 100, 0)
...
/obj/mecha/base_vehicle/vertibird/brotherhood/loaded/Initialize()
	. = ..()
	var/obj/item/mecha_parts/mecha_equipment/ME = new /obj/item/mecha_parts/mecha_equipment/weapon/ballistic/lmg/rapid
	ME.attach(src)
	ME = new /obj/item/mecha_parts/mecha_equipment/seat
...
/obj/mecha/base_vehicle/vertibird/balloon
...
/obj/mecha/base_vehicle/vertibird/balloon/GrantActions(mob/living/user, human_occupant = 0)
	internals_action.Grant(user, src)
	cycle_action.Grant(user, src)
	lights_action.Grant(user, src)
	stats_action.Grant(user, src)
...
/obj/mecha/base_vehicle/vertibird/balloon/RemoveActions(mob/living/user, human_occupant = 0)
	internals_action.Remove(user)
	cycle_action.Remove(user)
	lights_action.Remove(user)
	stats_action.Remove(user)
...
/obj/mecha/base_vehicle/vertibird/balloon/obj_destruction()
	for(var/mob/M in src)
...
/obj/mecha/base_vehicle/vertibird/balloon/loaded/Initialize()
	. = ..()
