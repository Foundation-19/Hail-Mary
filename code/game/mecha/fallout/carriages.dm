...
/obj/mecha/base_vehicle/buggy/legion
...
/obj/mecha/base_vehicle/buggy/legion/go_out()
	..()
	update_icon()

/obj/mecha/base_vehicle/buggy/legion/moved_inside(mob/living/carbon/human/H)
	..()
	update_icon()

/obj/mecha/base_vehicle/buggy/legion/GrantActions(mob/living/user, human_occupant = 0)
...
/obj/mecha/base_vehicle/buggy/legion/RemoveActions(mob/living/user, human_occupant = 0)
...
/obj/mecha/base_vehicle/buggy/legionarmed
...
/obj/mecha/base_vehicle/buggy/legionarmed/GrantActions(mob/living/user, human_occupant = 0)
	cycle_action.Grant(user, src)
	lights_action.Grant(user, src)
	stats_action.Grant(user, src)
	eject_action.Grant(user, src)
...
/obj/mecha/base_vehicle/buggy/legionarmed/RemoveActions(mob/living/user, human_occupant = 0)
	cycle_action.Remove(user)
	lights_action.Remove(user)
	stats_action.Remove(user)
	eject_action.Remove(user)
...
/obj/mecha/base_vehicle/truckcaravan/GrantActions(mob/living/user, human_occupant = 0)
	cycle_action.Grant(user, src)
	lights_action.Grant(user, src)
	stats_action.Grant(user, src)
	eject_action.Grant(user, src)
...
/obj/mecha/base_vehicle/truckcaravan/RemoveActions(mob/living/user, human_occupant = 0)
	cycle_action.Remove(user)
	lights_action.Remove(user)
	stats_action.Remove(user)
	eject_action.Remove(user)
...
/obj/mecha/base_vehicle/truckcaravan/loaded/Initialize()
	. = ..()
	var/obj/item/mecha_parts/mecha_equipment/ME = new
	ME = new /obj/item/mecha_parts/mecha_equipment/seat
	ME.attach(src)
