...
/obj/machinery/door/window/Bumped(atom/movable/AM)
	...
	if(!SSticker)
		return
	var/mob/M = AM
	if((isdrone(M) || iscyborg(M)) && M.stat != CONSCIOUS)
		return
	bumpopen(M)
...
/obj/machinery/door/window/CanAtmosPass(turf/T, vertical = FALSE)
...
/obj/machinery/door/window/ntnet_receive(datum/source, datum/netdata/data)
	..()
