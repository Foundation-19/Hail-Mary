...
/turf/closed/wall/f13/sunset/brick_small/baltimore
	name = "brick wall"
	desc = "A wall made out of solid brick."
	icon = 'icons/turf/walls/brick_small_baltimore.dmi'
	icon_state = "brick0"
	icon_type_smooth = "brick"
	hardness = 80
	smooth = SMOOTH_OLD
...
/turf/closed/wall/f13/sunset/brick_small_dark/baltimore
	name = "brick wall"
	desc = "A wall made out of solid brick."
	icon = 'icons/turf/walls/brick_small_dark_baltimore.dmi'
	icon_state = "brick0"
	icon_type_smooth = "brick"
	hardness = 80
	smooth = SMOOTH_OLD
...
/turf/closed/wall/f13/sunset/brick_small_light/baltimore
	name = "brick wall"
	desc = "A wall made out of solid brick."
	icon = 'icons/turf/walls/brick_small_light_baltimore.dmi'
	icon_state = "brick0"
	icon_type_smooth = "brick"
	hardness = 80
	smooth = SMOOTH_OLD
