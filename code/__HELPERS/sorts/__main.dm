...
TYPE_PROC_REF(/datum/sortInstance, timSort)(start, end)
	runBases.Cut()
	runLens.Cut()
...
*/
TYPE_PROC_REF(/datum/sortInstance, binarySort)(lo, hi, start)
...
*/
TYPE_PROC_REF(/datum/sortInstance, countRunAndMakeAscending)(lo, hi)
	//ASSERT(lo < hi)
...
TYPE_PROC_REF(/datum/sortInstance, minRunLength)(n)
	//ASSERT(n >= 0)
...
TYPE_PROC_REF(/datum/sortInstance, mergeCollapse)()
...
TYPE_PROC_REF(/datum/sortInstance, mergeForceCollapse)()
	while(runBases.len >= 2)
		var/n = runBases.len - 1
...
TYPE_PROC_REF(/datum/sortInstance, mergeAt)(i)
...
*/
TYPE_PROC_REF(/datum/sortInstance, gallopLeft)(key, base, len, hint)
 ...
 */
TYPE_PROC_REF(/datum/sortInstance, gallopRight)(key, base, len, hint)
	//ASSERT(len > 0 && hint >= 0 && hint < len)
...
TYPE_PROC_REF(/datum/sortInstance, mergeLo)(base1, len1, base2, len2)
...
TYPE_PROC_REF(/datum/sortInstance, mergeHi)(base1, len1, base2, len2)
	//ASSERT(len1 > 0 && len2 > 0 && base1 + len1 == base2)
...
TYPE_PROC_REF(/datum/sortInstance, mergeSort)(start, end)
	var/remaining = end - start
...
TYPE_PROC_REF(/datum/sortInstance, mergeAt2)(i)
