...
/mob/living/silicon/ai/ClickOn(atom/A, params)
	...
	if(!can_see(A))
		...
		log_admin(message)
		to_chat(src, span_warning("You're experiencing a bug. Reconnect immediately to fix it. Admins have been notified."))
	...
	if(aicamera.in_camera_mode)
		...
		INVOKE_ASYNC(aicamera, TYPE_PROC_REF(/obj/item/camera,ocaptureimage), pixel_turf, usr)
		return
	if(waypoint_mode)
		waypoint_mode = FALSE
