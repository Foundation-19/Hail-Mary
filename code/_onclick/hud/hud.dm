...
GLOBAL_LIST_INIT(available_ui_styles, list(
	"Fallout" = 'icons/UI/screen_fallout2.dmi', // Fallout 2 Pip-boy style UI. Walk the wasteland with style. -Pebbles
	"Darkout" = 'icons/UI/screen_fallout2_dark.dmi', // The original Fallout 2 pipboy UI, dark
