...
#define F13LEGIONSUBJECT	(1<<18)
#define F13LEGIONGOVERNOR	(1<<19)
...
#define JOB_DISPLAY_ORDER_LEGIONSUBJECT 136
#define JOB_DISPLAY_ORDER_LEGIONGOVERNOR 137
#define JOB_DISPLAY_ORDER_F13USCIT 138
