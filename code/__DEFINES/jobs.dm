...
#define F13REBELMEDIC     (1<<2)
#define F13REBELGUARD     (1<<3)
#define F13REBELCITIZEN     (1<<4)
...
#define JOB_DISPLAY_ORDER_F13REBELMEDIC	161
#define JOB_DISPLAY_ORDER_F13REBELGUARD	162
#define JOB_DISPLAY_ORDER_F13REBELCITIZEN	163
...
GLOBAL_LIST_INIT(faction_list, list(FACTION_NCR, FACTION_VAULT, FACTION_LEGION, FACTION_BROTHERHOOD, FACTION_EASTWOOD, FACTION_ENCLAVE, FACTION_WASTELAND, FACTION_RAIDERS, FACTION_SMUTANT, FACTION_ATLANTIC, FACTION_LOCUST))
