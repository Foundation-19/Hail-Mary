...
#define FACTION_WHITELEGS "White Legs"
#define FACTION_EIGHTIES "80s"
#define FACTION_LDS "New Canaanites"
#define FACTION_USPS "Post Office"
...
#define F13VETRANGER	 (1<<0)
#define F13PATROLRANGER	 (1<<1)
#define F13RANGERSCOUT	 (1<<2)
#define F13RANGERMEDIC	 (1<<3)
...
#define F13LANCER	(1<<14)
#define F13LANCERCAPTAIN	(1<<15)
...
#define F13BALTIMORERAIDER (1<<10)
...
#define F13SMUTANTLEADER		(1<<0)
#define F13SMUTANT		(1<<1)

#define ATLANTIC		(1<<14)

#define	F13ATLANTICCAP	(1<<0)
#define	F13ATLANTICDOC	(1<<1)
#define F13ATLANTICSAILOR	(1<<2)
#define F13ATLANTICMARINES	(1<<3)

#define DEP_LOCUST (1<<15)

#define F13BALTIMOREDOCKMASTER		(1<<0)
#define F13BALTIMORECONCELOR     (1<<1)
#define F13BALTIMOREFARMER	(1<<3)
#define F13BALTIMORESHOPCLERC		(1<<4)
#define F13BALTIMORERECLAIMER		(1<<5)
#define F13BALTIMOREMECHANIC    (1<<6)
#define F13BALTIMOREPREACHER		(1<<7)
#define F13BALTIMORECITIZEN 	(1<<8)
#define F13BALTIMORECOOK		(1<<9)
#define F13BALTIMOREBARKEEP		(1<<10)
#define F13BALTIMOREPILOT		(1<<11)
#define F13BALTIMORERADIOHOST	(1<<12)

#define DEP_MINUTEMEN (1<<16)

#define F13MINUTEMENLTCOLONEL		(1<<0)
#define F13MINUTEMENMAJOR		(1<<1)
#define F13MINUTEMENCAPTAIN		(1<<2)
#define F13MINUTEMENVET			(1<<3)
#define F13MINUTEMEN			(1<<4)


#define DEP_MERCENARY (1<<17)

#define F13MERCENARY (1<<0)
#define F13WARLORD (1<<1)
...
#define WHITELEGS		(1<<16)

#define F13WARCHIEF (1<<0)
#define F13LIGHTBRINGER (1<<1)
#define F13SAPPER (1<<2)
#define F13BONEBREAKER (1<<3)
#define F13PAINMAKER (1<<4)
#define F13STORMDRUMMER (1<<5)

#define EIGHTIES		(1<<17)

#define F13WARBOSS (1<<0)
#define F13ARENAMASTER (1<<1)
#define F13LAYMECHANIC (1<<2)
#define F13BLACKFINGER (1<<3)
#define F13BLUETEAM (1<<4)
#define F13REDTEAM (1<<5)
#define F13EIGHTY (1<<6)
#define F13ROADIE (1<<7)

#define LDS				(1<<18)

#define F13TEMPLEPRESIDENT (1<<0)
#define F13MISSIONARY (1<<1)
#define F13TEMPLEGUARD (1<<2)
#define F13NEWCANAANITE (1<<3)

#define USPS			(1<<19)

#define F13POSTMASTERGENERAL (1<<0)
#define F13MAILCARRIER (1<<1)
...
#define JOB_DISPLAY_ORDER_PATROLRANGER 50.9
#define JOB_DISPLAY_ORDER_MEDICRANGER 51
#define JOB_DISPLAY_ORDER_SCOUTRANGER 51.9
...
#define JOB_DISPLAY_ORDER_SLAVEMASTER 67.9
...
#define	JOB_DISPLAY_ORDER_F13ATLANTICCAP	136
#define	JOB_DISPLAY_ORDER_F13ATLANTICDOC	137
#define JOB_DISPLAY_ORDER_F13ATLANTICSAILOR	138
#define JOB_DISPLAY_ORDER_F13ATLANTICMARINES	139

#define JOB_DISPLAY_ORDER_F13BALTIMOREDOCKMASTER	140
#define JOB_DISPLAY_ORDER_F13BALTIMORECONCELOR	141
#define JOB_DISPLAY_ORDER_F13MINUTEMENMAJOR	142
#define JOB_DISPLAY_ORDER_F13MINUTEMENCAPTAIN	143
#define JOB_DISPLAY_ORDER_F13BALTIMOREFARMER	144
#define JOB_DISPLAY_ORDER_F13BALTIMORESHOPCLERC		145
#define JOB_DISPLAY_ORDER_F13BALTIMORERECLAIMER		146
#define JOB_DISPLAY_ORDER_F13BALTIMOREMECHANIC    147
#define JOB_DISPLAY_ORDER_F13BALTIMOREPREACHER	148
#define JOB_DISPLAY_ORDER_F13BALTIMORECITIZEN 	149
#define JOB_DISPLAY_ORDER_F13BALTIMORECOOK	150
#define JOB_DISPLAY_ORDER_F13BALTIMOREBARKEEP	151	
#define JOB_DISPLAY_ORDER_F13BALTIMOREPILOT	152
#define JOB_DISPLAY_ORDER_F13BALTIMORERADIOHOST	153
...
#define JOB_DISPLAY_ORDER_WARCHIEF 168
#define JOB_DISPLAY_ORDER_LIGHTBRINGER 169
#define JOB_DISPLAY_ORDER_SAPPER 170
#define JOB_DISPLAY_ORDER_BONEBREAKER 171
#define JOB_DISPLAY_ORDER_PAINMAKER 172
#define JOB_DISPLAY_ORDER_STORMDRUMMER 173

#define JOB_DISPLAY_ORDER_WARBOSS 174
#define JOB_DISPLAY_ORDER_ARENAMASTER 175
#define JOB_DISPLAY_ORDER_LAYMECHANIC 176
#define JOB_DISPLAY_ORDER_BLACKFINGER 177
#define JOB_DISPLAY_ORDER_EIGHTY 178
#define JOB_DISPLAY_ORDER_BLUETEAM 179
#define JOB_DISPLAY_ORDER_REDTEAM 180
#define JOB_DISPLAY_ORDER_ROADIE 181

#define JOB_DISPLAY_ORDER_TEMPLEPRESIDENT 182
#define JOB_DISPLAY_ORDER_MISSIONARY 183
#define JOB_DISPLAY_ORDER_TEMPLEGUARD 184
#define JOB_DISPLAY_ORDER_NEWCANAANITE 185

#define JOB_DISPLAY_ORDER_POSTMASTERGENERAL 186
#define JOB_DISPLAY_ORDER_MAILCARRIER 187

#define JOB_DISPLAY_ORDER_LANCER 188
#define JOB_DISPLAY_ORDER_LANCERCAPTAIN 189

#define JOB_DISPLAY_ORDER_F13MERCENARY 190
#define JOB_DISPLAY_ORDER_F3WARLORD 191
#define JOB_DISPLAY_ORDER_F13BALTIMORERAIDER 192
#define JOB_DISPLAY_ORDER_F13MINUTEMENLTCOLONEL	193
#define JOB_DISPLAY_ORDER_F13MINUTEMENLTVET	194

GLOBAL_LIST_INIT(faction_list, list(FACTION_NCR, FACTION_LEGION, FACTION_BROTHERHOOD, FACTION_EASTWOOD, FACTION_ENCLAVE, FACTION_WASTELAND, FACTION_RAIDERS, FACTION_SMUTANT, FACTION_ATLANTIC, FACTION_LOCUST, FACTION_RANGER, FACTION_WHITELEGS, FACTION_EIGHTIES, FACTION_LDS, FACTION_USPS,  FACTION_MERCENARY))
