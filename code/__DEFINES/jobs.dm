...
#define JOB_DISPLAY_ORDER_LANCER 155
#define JOB_DISPLAY_ORDER_LANCERCAPTAIN 156

#define JOB_DISPLAY_ORDER_F13MERCENARY 157
#define JOB_DISPLAY_ORDER_F3WARLORD 158
#define JOB_DISPLAY_ORDER_F13BALTIMORERAIDER 159
#define JOB_DISPLAY_ORDER_F13MINUTEMENLTCOLONEL	160

GLOBAL_LIST_INIT(faction_list, list(FACTION_NCR, FACTION_LEGION, FACTION_BROTHERHOOD, FACTION_EASTWOOD, FACTION_ENCLAVE, FACTION_WASTELAND, FACTION_RAIDERS, FACTION_SMUTANT, FACTION_ATLANTIC, FACTION_LOCUST, FACTION_MINUTEMEN, FACTION_RANGER,  FACTION_MERCENARY))
