...
#define F13BALTIMORECONSTABLE		(1<<2)
#define F13BALTIMOREPOLICE		(1<<3)
#define F13BALTIMOREFARMER	(1<<4)
#define F13BALTIMORESHOPCLERC		(1<<5)
#define F13BALTIMORERECLAIMER		(1<<6)
#define F13BALTIMOREMECHANIC    (1<<7)
#define F13BALTIMOREPREACHER		(1<<8)
#define F13BALTIMORECITIZEN 	(1<<9)
#define F13BALTIMORECOOK		(1<<10)
...
#define JOB_DISPLAY_ORDER_F13BALTIMORECONSTABLE	142
#define JOB_DISPLAY_ORDER_F13BALTIMOREPOLICE	143
...
GLOBAL_LIST_INIT(faction_list, list(FACTION_NCR, FACTION_LEGION, FACTION_BROTHERHOOD, FACTION_EASTWOOD, FACTION_ENCLAVE, FACTION_WASTELAND, FACTION_RAIDERS, FACTION_SMUTANT, FACTION_ATLANTIC, FACTION_LOCUST, FACTION_RANGER, FACTION_WHITELEGS, FACTION_EIGHTIES, FACTION_LDS, FACTION_USPS))
