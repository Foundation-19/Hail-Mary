...
#define LOG_PDA			(1 << 7)
#define LOG_CHAT		(1 << 8)
#define LOG_COMMENT		(1 << 9)
#define LOG_TELECOMMS	(1 << 10)
#define LOG_OOC			(1 << 11)
#define LOG_ADMIN		(1 << 12)
#define LOG_OWNERSHIP	(1 << 13)
#define LOG_GAME		(1 << 14)
#define LOG_ADMIN_PRIVATE (1 << 15)
#define LOG_ASAY		(1 << 16)
...
#define INDIVIDUAL_COMMS_LOG		(LOG_PDA | LOG_CHAT | LOG_COMMENT | LOG_TELECOMMS | LOG_TERMINAL)
#define INDIVIDUAL_IC_LOG			(LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_PDA | LOG_CHAT | LOG_COMMENT | LOG_TELECOMMS | LOG_TERMINAL)
