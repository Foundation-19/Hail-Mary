...
#define EXP_TIER_MISC     "Misc"
#define EXP_TIER_ENLISTED "Enlisted"
/// Separator between faction and tier in compound exp_type_exempt keys.
#define EXP_TIER_SEP "/"
