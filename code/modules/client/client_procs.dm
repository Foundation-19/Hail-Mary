	...
	//SECURITY//
	////////////
#define UPLOAD_LIMIT		3145728	//Restricts client uploads to the server to 1MB //Could probably do with being lower. //ATOM EDIT changed it to 3mb,since 1mb is almost unusable
