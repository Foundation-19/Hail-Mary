...
/obj/item/assembly/control/activate()
	...
	for(var/obj/machinery/door/poddoor/M in GLOB.machines)
		if(M.id == src.id)
			if(openclose == null)
				openclose = M.density
			INVOKE_ASYNC(M, openclose ?TYPE_PROC_REF(/obj/machinery/door/poddoor.proc/open : /obj/machinery/door/poddoor,close))
...
/obj/item/assembly/control/airlock/activate()
	...
	for(var/D in open_or_close)
		INVOKE_ASYNC(D, doors_need_closing ?TYPE_PROC_REF(/obj/machinery/door/airlock.proc/close : /obj/machinery/door/airlock,open))
