...
/datum/map_config
	// Metadata
	var/config_filename = "_maps/pahrump-only.json"
	...
	var/list/removed_jobs = list("enclave.dm","atlantic_cross.dm","locust_point.dm", "outlaws.dm", "khan.dm")   //Removes the "none" faction using job name - can also use #all# (case sensitive)
