TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, toggle_on_off)()
	if(s_busy)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, ninitialize)(delay = s_delay, mob/living/carbon/human/U = loc)
	if(!U.mind)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, ninitialize_two)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, ninitialize_three)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, ninitialize_four)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, ninitialize_five)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, ninitialize_six)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, ninitialize_seven)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize)(delay = s_delay)
	if(affecting==loc)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize_two)(delay, mob/living/carbon/human/U)
	to_chat(U, span_notice("Now de-initializing..."))
	addtimer(CALLBACK(src, PROC_REF(deinitialize_three), delay, U), delay)

TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize_three)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize_four)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize_five)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize_six)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize_seven)(delay, mob/living/carbon/human/U)
...
TYPE_PROC_REF(/obj/item/clothing/suit/space/space_ninja, deinitialize_eight)(delay, mob/living/carbon/human/U)
