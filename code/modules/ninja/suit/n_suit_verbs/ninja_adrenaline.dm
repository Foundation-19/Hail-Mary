...
/obj/item/clothing/suit/space/space_ninja/proc/ninjaboost()
	...
	if(!ninjacost(0,N_ADRENALINE))
		...
		H.do_adrenaline(150, TRUE, 0, 0, TRUE, list(/datum/reagent/medicine/inaprovaline = 3, /datum/reagent/medicine/synaptizine = 10, /datum/reagent/medicine/omnizine = 10), span_boldnotice("You feel a sudden surge of energy!"))
