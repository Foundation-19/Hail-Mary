TYPE_PROC_REF(/datum/admins, CheckAdminHref)(href, href_list)
...
/datum/admins/Topic(href, href_list)
	...
	if(href_list["ahelp"])
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): getplaytimewindow without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): getplaytimewindow without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggleexempt without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggleexempt without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): makeAntag without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): makeAntag without admin perms.")
			return
		if (!SSticker.mode)
	...
	if(href_list["editrightsbrowsermanage"])
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): gamemode_panel without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): gamemode_panel without admin perms.")
			return
		SSticker.mode.admin_panel()

	else if(href_list["call_shuttle"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): call_shuttle without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): call_shuttle without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): trigger_centcom_recall without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): trigger_centcom_recall without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggle_continuous without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggle_continuous without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggle_midround_antag without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggle_midround_antag without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): alter_midround_time_limit without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): alter_midround_time_limit without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): alter_midround_life_limit without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): alter_midround_life_limit without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggle_noncontinuous_behavior without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): toggle_noncontinuous_behavior without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): end_round without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): end_round without admin perms.")
			return
...
//Regular jobs
	...
	//JOBBAN'S INNARDS
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): boot2 without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): boot2 without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addmessage without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addmessage without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addnote without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addnote without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addwatch without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addwatch without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addmemo without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addmemo without admin perms.")
			return
		create_message("memo", secret = 0, browse = 1)

	else if(href_list["addmessageempty"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addmessageempty without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addmessageempty without admin perms.")
			return
		create_message("message", secret = 0)

	else if(href_list["addnoteempty"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addnoteempty without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addnoteempty without admin perms.")
			return
		create_message("note")

	else if(href_list["addwatchempty"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addwatchempty without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): addwatchempty without admin perms.")
			return
		create_message("watchlist entry", secret = 1)

	else if(href_list["deletemessage"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): deletemessage without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): deletemessage without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): deletemessageempty without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): deletemessageempty without admin perms.")
			return
		var/safety = alert("Delete message/note?",,"Yes","No");
		if (safety == "Yes")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessage without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessage without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageempty without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageempty without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageexpiry without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageexpiry without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageexpiryempty without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageexpiryempty without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageseverity without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): editmessageseverity without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): secretmessage without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): secretmessage without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): nonalpha without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, searchmessages)(): nonalpha without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): nonalpha without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): nonalpha without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showmessages without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showmessages without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showmemo without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showmemo without admin perms.")
			return
		browse_messages("memo")

	else if(href_list["showwatch"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showwatch without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showwatch without admin perms.")
			return
		browse_messages("watchlist entry")

	else if(href_list["showwatchfilter"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showwatchfilter without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showwatchfilter without admin perms.")
			return
		browse_messages("watchlist entry", filter = 1)

	else if(href_list["showmessageckey"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showmessageckey without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showmessageckey without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): messageedits without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): messageedits without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): mute without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): mute without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_clear without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_clear without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_remove without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_remove without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_storyteller without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_storyteller without admin perms.")
			return
		if(SSticker && SSticker.mode)
			return alert(usr, "The game has already started.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_storyteller_clear without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_storyteller_clear without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_latejoin without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_latejoin without admin perms.")
			return
		if(!SSticker || !SSticker.mode)
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_latejoin_clear without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_latejoin_clear without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_midround without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_midround without admin perms.")
			return
		if(!SSticker || !SSticker.mode)
			return alert(usr, "The game must start first.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_options without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_options without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_centre without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_centre without admin perms.")
			return
		if(SSticker && SSticker.mode)
			return alert(usr, "The game has already started.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_width without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_width without admin perms.")
			return
		if(SSticker && SSticker.mode)
			return alert(usr, "The game has already started.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_latejoin_min without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_latejoin_min without admin perms.")
			return
		if(SSticker && SSticker.mode)
			return alert(usr, "The game has already started.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_latejoin_max without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_latejoin_max without admin perms.")
			return
		if(SSticker && SSticker.mode)
			return alert(usr, "The game has already started.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_midround_min without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_midround_min without admin perms.")
			return
		if(SSticker && SSticker.mode)
			return alert(usr, "The game has already started.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_midround_max without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_roundstart_midround_max without admin perms.")
			return
		if(SSticker && SSticker.mode)
			return alert(usr, "The game has already started.", null, null, null, null)
		if(GLOB.master_mode != "dynamic")
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_force_extended without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_force_extended without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_no_stacking without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_no_stacking without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_classic_secret without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_classic_secret without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_stacking_limit without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_stacking_limit without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_high_pop_limit without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_high_pop_limit without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_forced_threat without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): f_dynamic_forced_threat without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): makeeligible without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): makeeligible without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sendtoprison without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sendtoprison without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sendbacktolobby without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sendbacktolobby without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): revive without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): revive without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): admingetmovable without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): admingetmovable without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): adminchecklaws without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): adminchecklaws without admin perms.")
			return
		output_ai_laws()

	else if(href_list["admincheckdevilinfo"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): admincheckdevilinfo without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): admincheckdevilinfo without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): addjobslot without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): addjobslot without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): customjobslot without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): customjobslot without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): removejobslot without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): removejobslot without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): unlimitjobslot without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): unlimitjobslot without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): limitjobslot without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): limitjobslot without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): CentComReply without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): CentComReply without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): SyndicateReply without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): SyndicateReply without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): HeadsetMessage without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): HeadsetMessage without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): reject_custom_name without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): reject_custom_name without admin perms.")
			return
		...
		if(!check_rights(R_SPAWN)) //fortuna edit. event manager change
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): getmob without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): getmob without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sendmob without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sendmob without admin perms.")
			return
		...
		if(!check_rights(R_SPAWN)) //fortuna edit. event manager change
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): narrateto without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): narrateto without admin perms.")
			return
		...
		if(!check_rights(R_SPAWN)) //fortuna edit. event manager change
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): subtlemessage without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): subtlemessage without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): individuallog without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): individuallog without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): languagemenu without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): languagemenu without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): traitor without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): traitor without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): borgpanel without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): borgpanel without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): initmind without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): initmind without admin perms.")
			return
...
//fortuna addition end
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_view_wanted without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_view_wanted without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_channel_name without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_channel_name without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_channel_lock without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_channel_lock without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_submit_new_channel without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_submit_new_channel without admin perms.")
			return
		var/check = 0
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_channel_receiving without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_channel_receiving without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_new_message without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_new_message without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_submit_new_message without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_submit_new_message without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_create_channel without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_create_channel without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_create_feed_story without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_create_feed_story without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_menu_censor_story without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_menu_censor_story without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_menu_censor_channel without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_menu_censor_channel without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_menu_wanted without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_menu_wanted without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_wanted_name without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_wanted_name without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_wanted_desc without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_wanted_desc without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_submit_wanted without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_submit_wanted without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_cancel_wanted without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_cancel_wanted without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_censor_channel_author without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_censor_channel_author without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_censor_channel_story_author without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_censor_channel_story_author without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_censor_channel_story_body without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_censor_channel_story_body without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_pick_d_notice without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_pick_d_notice without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_toggle_d_notice without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_toggle_d_notice without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_view without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_view without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_setScreen without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_setScreen without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_show_channel without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_show_channel without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_pick_censor_channel without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_pick_censor_channel without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_refresh without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_refresh without admin perms.")
			return
		src.access_news_network()

	else if(href_list["ac_set_signature"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_signature without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_set_signature without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_del_comment without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_del_comment without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_lock_comment without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): ac_lock_comment without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): check_antagonist without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): check_antagonist without admin perms.")
			return
		usr.client.check_antagonists()

	else if(href_list["kick_all_from_lobby"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): kick_all_from_lobby without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): kick_all_from_lobby without admin perms.")
			return
		...
		if(!check_rights(R_SPAWN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): create_outfit without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): create_outfit without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): set_selfdestruct_code without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): set_selfdestruct_code without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): add_station_goal without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): add_station_goal without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showrelatedacc without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): showrelatedacc without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): centcomlookup without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): centcomlookup without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): modantagrep without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): modantagrep without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): slowquery without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): slowquery without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): interview without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): interview without admin perms.")
			return
		...
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): interview_man without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): interview_man without admin perms.")
			return
		GLOB.interviews.ui_interact(usr)

	else if(href_list["sleep"])
		if(!check_rights(R_ADMIN))
			message_admins("[ADMIN_TPMONTY(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sleep without admin perms.")
			log_admin("INVALID ADMIN PROC ACCESS: [key_name(usr)] tried to use TYPE_PROC_REF(/datum/admins, CheckAdminHref)(): sleep without admin perms.")
			return
...
TYPE_PROC_REF(/datum/admins, HandleCMode)()
	if(!check_rights(R_ADMIN))
...
TYPE_PROC_REF(/datum/admins, HandleFSecret)()
	if(!check_rights(R_ADMIN))
...
TYPE_PROC_REF(/datum/admins, makeMentor)(ckey)
	if(!usr.client)
		return
	if (!check_rights(0))
		return
...
TYPE_PROC_REF(/datum/admins, removeMentor)(ckey)
	if(!usr.client)
		return
	if (!check_rights(0))
		return
