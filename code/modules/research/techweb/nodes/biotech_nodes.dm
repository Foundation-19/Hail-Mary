...
/datum/techweb_node/adv_biotech
	...
	design_ids = list("crewpinpointer", "plasmarefiller", "limbgrower", "meta_beaker", "healthanalyzer_advanced", "harvester", "holobarrier_med", "defibrillator_compact", "containmentbodybag")
