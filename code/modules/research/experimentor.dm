...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, ConvertReqString2List)(list/source_list)
...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, SetTypeReactions)()
...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, checkCircumstances)(obj/item/O)
...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, matchReaction)(matching,reaction)
...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, ejectItem)(delete=FALSE)
	if(loaded_item)
		if(cloneMode)
...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, throwSmoke)(turf/where)
	var/datum/effect_system/smoke_spread/smoke = new
	smoke.set_up(0, where)
	smoke.start()


TYPE_PROC_REF(/obj/machinery/rnd/experimentor, experiment)(exp,obj/item/exp_on)
...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, reset_exp)()
	update_icon()
...
TYPE_PROC_REF(/obj/machinery/rnd/experimentor, warn_admins)(user, ReactionName)
...
TYPE_PROC_REF(/obj/item/relic, reveal)()
...
TYPE_PROC_REF(/obj/item/relic, cd)()
	cooldown = FALSE

//////////////// RELIC PROCS /////////////////////////////

TYPE_PROC_REF(/obj/item/relic, throwSmoke)(turf/where)
	var/datum/effect_system/smoke_spread/smoke = new
	smoke.set_up(0, get_turf(where))
	smoke.start()

TYPE_PROC_REF(/obj/item/relic, corgicannon)(mob/user)
...
TYPE_PROC_REF(/obj/item/relic, clean)(mob/user)
	playsound(src, "sparks", rand(25,50), 1)
...
TYPE_PROC_REF(/obj/item/relic, flash)(mob/user)
	playsound(src, "sparks", rand(25,50), 1)
	var/obj/item/grenade/flashbang/CB = new/obj/item/grenade/flashbang(user.loc)
	CB.prime()
	warn_admins(user, "Flash")

TYPE_PROC_REF(/obj/item/relic, petSpray)(mob/user)
...
TYPE_PROC_REF(/obj/item/relic, rapidDupe)(mob/user)
...
TYPE_PROC_REF(/obj/item/relic, warn_admins)(mob/user, RelicType, priority = 1)
