...
/obj/item/melee/cultblade/dagger/examine(mob/user)
	...
	if(iscultist(user) || isobserver(user))
		. += span_cult("The scriptures of the Geometer. Allows the scribing of runes and access to the knowledge archives of the cult of Nar'Sie.")
		. += span_cult("Striking a cult structure will unanchor or reanchor it.")
