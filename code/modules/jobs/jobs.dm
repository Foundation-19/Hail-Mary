...
/// Tier names: Admin, Officer, Senior NCO, NCO, Misc, Enlisted.
GLOBAL_LIST_INIT(exp_tiermap, list(
	...
	"Brotherhood of Steel/Admin"      = list("Elder Envoy", "Sentinel"),
	...
	// Legion
	"Legion/Admin"      = list("Legion Orator", "Legion Centurion"),
	...
	// Vault
	"Vault/Admin"    = list("Overseer", "Chief of Security"),
	...
	// Eastwood
	"Eastwood/Admin"    = list("Warden", "Secretary", "Head of the Watch"),
	...
	// Wasteland
	"Wasteland/Admin"    = list("Den Mob Boss", "Preacher"),
...
GLOBAL_LIST_INIT(exp_tier_order, list(EXP_TIER_ENLISTED, EXP_TIER_NCO, EXP_TIER_SNCO, EXP_TIER_OFFICER, EXP_TIER_ADMIN))
...
GLOBAL_LIST_INIT(exp_tier_requirements, list(
	...
	EXP_TIER_ADMIN    = list("faction" = 4500, "other_faction" = 2100),   // 75h own faction + 35h any other faction
))
