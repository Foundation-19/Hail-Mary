...
/datum/job/baltimore_bos //do NOT use this for anything, it's just to store faction datums.
	department_flag = BOS
	...
	outfit = /datum/outfit/job/baltimore_bos/
...
/datum/outfit/job/baltimore_bos
	name = "bosdatums"
	jobtype = /datum/job/baltimore_bos
...
/datum/outfit/job/baltimore_bos/pre_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return

/datum/outfit/job/baltimore_bos/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
...
/datum/job/baltimore_bos/f13envoy
	title = "Elder Envoy"
	flag = F13ENVOY
	...
	outfit = /datum/outfit/job/baltimore_bos/f13envoy
	req_admin_notify = 1
...
/datum/outfit/job/baltimore_bos/f13sentinel/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
...
/datum/outfit/job/baltimore_bos/f13envoy
	name = "Elder Envoy"
	jobtype = /datum/job/baltimore_bos/f13envoy
...
/datum/job/bos/f13lancercaptain
	...
	total_positions = 1
	spawn_positions = 1
	description = "You are the commanding officer of the brotherhood airship ''Avalonian''. You are tasked to plan operations, coordonate the lancers, and command the brotherhood."
	supervisors = "The Elder or their Envoy"

	outfit = /datum/outfit/job/bos/f13lancercaptain
...
/datum/outfit/job/baltimore_bos/f13commander/pre_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	ADD_TRAIT(H, TRAIT_PA_WEAR, src)

/datum/outfit/job/baltimore_bos/f13commander/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/jet)
...
/datum/outfit/job/baltimore_bos/f13commander
	name = "Paladin Commander"
	jobtype = /datum/job/baltimore_bos/f13paladincommander
...
/datum/job/baltimore_bos/f13headscribe
	title = "Head Scribe"
	flag = F13HEADSCRIBE
	head_announce = list("Security")
	total_positions = 1
	...
	outfit = /datum/outfit/job/baltimore_bos/f13headscribe
...
/datum/outfit/job/baltimore_bos/f13headscribe/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/jet)
...
/datum/outfit/job/baltimore_bos/f13headscribe
	name = "Head Scribe"
	jobtype = /datum/job/baltimore_bos/f13headscribe
	chemwhiz = TRUE
...
/datum/job/baltimore_bos/f13knightcap
	...
	outfit = /datum/outfit/job/baltimore_bos/f13knightcap
...
/datum/outfit/job/baltimore_bos/f13knightcap/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/bos_st45helm_convert)
...
/datum/outfit/job/baltimore_bos/f13knightcap
	name = "Knight-Captain"
	jobtype = /datum/job/baltimore_bos/f13knightcap
	gunsmith_one = TRUE
	gunsmith_two = TRUE
	gunsmith_three = TRUE
	gunsmith_four = TRUE
...
/datum/job/baltimore_bos/f13paladin
	title = "Paladin"
	flag = F13PALADIN
	total_positions = 1
	spawn_positions = 1
...
/datum/outfit/job/baltimore_bos/f13paladin/pre_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/bos_ca_convert)
...
/datum/outfit/job/baltimore_bos/f13paladin
	name =	"Paladin"
	jobtype =	/datum/job/baltimore_bos/f13paladin
...
/datum/job/baltimore_bos/f13seniorscribe
	title = "Senior Scribe"
	...
	outfit = /datum/outfit/job/baltimore_bos/f13seniorscribe
	...
	matchmaking_allowed = list(
		...
		/datum/matchmaking_pref/mentor = list(
			/datum/job/baltimore_bos/f13scribe,
		),
	)

/datum/outfit/job/baltimore_bos/f13seniorscribe/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/bos_ca_convert)
...
/datum/outfit/job/baltimore_bos/f13seniorscribe
	name =	"Senior Scribe"
	jobtype = /datum/job/baltimore_bos/f13seniorscribe
	chemwhiz =	TRUE
	belt = /obj/item/storage/belt/utility/full/engi
...
/datum/job/baltimore_bos/f13scribe
	...
	outfit = /datum/outfit/job/baltimore_bos/f13scribe
	exp_requirements = 30
...
/datum/outfit/job/baltimore_bos/f13scribe
	name = "Scribe"
	jobtype = /datum/job/baltimore_bos/f13scribe
	chemwhiz = TRUE
	belt = /obj/item/storage/belt/utility/full/engi
	shoes = /obj/item/clothing/shoes/combat
...
/datum/outfit/job/baltimore_bos/f13scribe/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/bos_ca_convert)
...
/datum/outfit/job/baltimore_bos/f13knightsarge/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
...
/datum/outfit/job/baltimore_bos/f13knight/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/AER9)
...
/datum/outfit/job/baltimore_bos/f13initiate
	name = "Initiate"
	jobtype = /datum/job/baltimore_bos/f13initiate
	backpack_contents = list(
		/obj/item/melee/onehanded/knife/survival = 1
		)

/*
/datum/outfit/job/baltimore_bos/f13initiate/post_equip(mob/living/carbon/human/H, visualsOnly)
	..()
	if(visualsOnly)
		return
