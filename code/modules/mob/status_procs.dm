...
TYPE_PROC_REF(/mob, Jitter)(amount)
 ...
 */
TYPE_PROC_REF(/mob, adjust_blindness)(amount)
 ...
 */
TYPE_PROC_REF(/mob, set_blindness)(amount)
	var/old_eye_blind = eye_blind
...
TYPE_PROC_REF(/mob, update_blindness)()
 ...
 */
TYPE_PROC_REF(/mob, blur_eyes)(amount)
	if(amount>0)
 ...
 */
TYPE_PROC_REF(/mob, adjust_blurriness)(amount)
	eye_blurry = max(eye_blurry+amount, 0)
	update_eyeblur()

///Set the mobs blurriness of vision to an amount
TYPE_PROC_REF(/mob, set_blurriness)(amount)
	eye_blurry = max(amount, 0)
	update_eyeblur()

TYPE_PROC_REF(/mob, update_eyeblur)()
	remove_eyeblur()
	if(eye_blurry)
		add_eyeblur()

TYPE_PROC_REF(/mob, add_eyeblur)()
	if(!client)
		return
...
TYPE_PROC_REF(/mob, remove_eyeblur)()
	if(!client)
		return
	var/list/screens = list(hud_used.plane_masters["[GAME_PLANE]"], hud_used.plane_masters["[OBJITEM_PLANE]"], hud_used.plane_masters["[MOB_PLANE]"], hud_used.plane_masters["[FLOOR_PLANE]"],
							hud_used.plane_masters["[WALL_PLANE]"], hud_used.plane_masters["[ABOVE_WALL_PLANE]"])
...
TYPE_PROC_REF(/mob, adjust_drugginess)(amount)
	return

///Set the drugginess of a mob
TYPE_PROC_REF(/mob, set_drugginess)(amount)
	return

///Adjust the disgust level of a mob
TYPE_PROC_REF(/mob, adjust_disgust)(amount)
	return

///Set the disgust level of a mob
TYPE_PROC_REF(/mob, set_disgust)(amount)
	return

///Adjust the body temperature of a mob, with min/max settings
TYPE_PROC_REF(/mob, adjust_bodytemperature)(amount,min_temp=0,max_temp=INFINITY)
	if(bodytemperature >= min_temp && bodytemperature <= max_temp)
		bodytemperature = clamp(bodytemperature + amount,min_temp,max_temp)

/////////////////////////////////// FIRE DELAY ////////////////////////////////////

TYPE_PROC_REF(/mob, IsWeaponDrawDelayed)() //non-living mobs shouldn't be stunned
	return FALSE

/////////////////////////////////// THROW DELAY ////////////////////////////////////

TYPE_PROC_REF(/mob, IsThrowDelayed)() //non-living mobs shouldn't be stunned
	return FALSE
