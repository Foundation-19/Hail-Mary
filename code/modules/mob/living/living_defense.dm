...
/mob/living/narsie_act()
	...
	if(client)
		INVOKE_ASYNC(GLOBAL_PROC,GLOBAL_PROC_REF(makeNewConstruct), /mob/living/simple_animal/hostile/construct/harvester, src, null, TRUE) // must pass keyword args explicitly
	else
		switch(rand(1, 6))
			if(1)
