 ...
 */
TYPE_PROC_REF(/datum/song, do_hearcheck)()
 ...
 */
TYPE_PROC_REF(/datum/song, set_instrument)(datum/instrument/I)
 ...
 */
TYPE_PROC_REF(/datum/song, start_playing)(mob/user)
	if(playing)
		return
 ...
 */
TYPE_PROC_REF(/datum/song, stop_playing)()
	if(!playing)
		return
	playing = FALSE
	if(!debug_mode)
 ...
 * Processes our song.
 */
TYPE_PROC_REF(/datum/song, process_song)(wait)
 ...
 */
TYPE_PROC_REF(/datum/song, tempodiv_to_delay)(tempodiv)
	if(!tempodiv)
 ...
 * Compiles chords.
 */
TYPE_PROC_REF(/datum/song, compile_chords)()
	legacy? compile_legacy() : compile_synthesized()

/**
 * Plays a chord.
 */
TYPE_PROC_REF(/datum/song, play_chord)(list/chord)
 ...
 */
TYPE_PROC_REF(/datum/song, should_stop_playing)(mob/user)
 ...
 */
TYPE_PROC_REF(/datum/song, update_sustain)()
	// Exponential is easy
 ...
 */
TYPE_PROC_REF(/datum/song, set_volume)(volume)
 ...
 */
TYPE_PROC_REF(/datum/song, set_dropoff_volume)(volume)
 ...
 */
TYPE_PROC_REF(/datum/song, set_exponential_drop_rate)(drop)
 ...
 */
TYPE_PROC_REF(/datum/song, set_linear_falloff_duration)(duration)
