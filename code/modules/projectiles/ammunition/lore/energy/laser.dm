...
/obj/item/ammo_casing/energy/laser/pistol/wattzs/hitscan
	...
	e_cost = 37.5 //40 Shots
	damage_threshold_penetration = 3 // Sports Edition wins on efficiency, not pierce - AEP7 keeps its armor-penetrating edge
...
/obj/item/ammo_casing/energy/laser/autolaser/shock
	projectile_type = /obj/item/projectile/energy/teslacannon/eastwood
