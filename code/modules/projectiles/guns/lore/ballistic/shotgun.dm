...
/obj/item/gun/ballistic/shotgun/automatic/combat/neostead
	...
	weapon_class = WEAPON_CLASS_RIFLE
	weapon_weight = GUN_TWO_HAND_ONLY
	damage_multiplier = GUN_LESS_DAMAGE_T1 // pays for the free dual-tube ammo-type swap, same as Sidewinder's caliber-swap tax
...
/obj/item/gun/ballistic/automatic/shotgun/pancor
	...
	weapon_class = WEAPON_CLASS_RIFLE
	weapon_weight = GUN_TWO_HAND_ONLY
	damage_multiplier = GUN_LESS_DAMAGE_T2 // full-auto buckshot is a much bigger DPS step than semi-auto drum shotguns, needs a bigger discount than riot's T1
	init_recoil = RIFLE_RECOIL(2.8)
	init_firemodes = list(
