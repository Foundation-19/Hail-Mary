...
TYPE_PROC_REF(/obj/structure/particle_accelerator/particle_emitter, set_delay)(delay)
	if(delay >= 0)
		fire_delay = delay
		return 1
	return 0

TYPE_PROC_REF(/obj/structure/particle_accelerator/particle_emitter, emit_particle)(strength = 0)
