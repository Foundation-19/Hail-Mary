...
/obj/singularity/attack_tk(mob/user)
	if(iscarbon(user))
		...
		C.visible_message(span_danger("[C]'s head begins to collapse in on itself!"), span_userdanger("Your head feels like it's collapsing in on itself! This was really not a good idea!"), span_italic("You hear something crack and explode in gore."))
		for(var/i in 1 to 3)
