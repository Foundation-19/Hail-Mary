...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Nuka X-Treme",				/obj/item/reagent_containers/food/drinks/drinkingglass/filled/nukaxtreme,			1000),
		new /datum/data/mining_equipment("Nukacide",					/obj/item/reagent_containers/food/drinks/drinkingglass/filled/nukacide,	250),
