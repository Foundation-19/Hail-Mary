...
TYPE_PROC_REF(/obj/item/clothing/suit/armor/reactive, block_action)(mob/living/owner, atom/object, damage, attack_text, attack_type, armour_penetration, mob/attacker, def_zone, final_block_chance, list/block_return)
	return BLOCK_NONE
