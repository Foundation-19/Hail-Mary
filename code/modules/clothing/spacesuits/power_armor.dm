...
/* T60, needs sprite
/obj/item/clothing/head/helmet/space/hardsuit/power_armor/t60
...
/obj/item/clothing/suit/space/hardsuit/power_armor/t60
	name = "T60 Power Armor Suit"
	desc = ""
  armor = list(MELEE = 90, BULLET = 90, LASER = 90, ENERGY = 90, BOMB = 90, BIO = 100, RAD = 100, FIRE = 100, ACID = 100)	
  icon = ''
  worn_icon = ''
	icon_state = ""
	worn_icon_state = ""
helmettype = /obj/item/clothing/head/helmet/space/hardsuit/power_armor/t60
*/

/* X01, needs sprite
/obj/item/clothing/head/helmet/space/hardsuit/power_armor/x01
...
/obj/item/clothing/suit/space/hardsuit/power_armor/x01
	name = "X01 Power Armor Suit"
	desc = ""
  armor = list(MELEE = 90, BULLET = 90, LASER = 90, ENERGY = 90, BOMB = 90, BIO = 100, RAD = 100, FIRE = 100, ACID = 100)	
  icon = ''
  worn_icon = ''
	icon_state = ""
	worn_icon_state = ""
helmettype = /obj/item/clothing/head/helmet/space/hardsuit/power_armor/x01
*/

/* X02, needs sprite
/obj/item/clothing/head/helmet/space/hardsuit/power_armor/x02
...
/obj/item/clothing/suit/space/hardsuit/power_armor/x02
	name = "X02 Power Armor Suit"
	desc = ""
  armor = list(MELEE = 90, BULLET = 90, LASER = 90, ENERGY = 90, BOMB = 90, BIO = 100, RAD = 100, FIRE = 100, ACID = 100)	
  icon = ''
  worn_icon = ''
	icon_state = ""
	worn_icon_state = ""
helmettype = /obj/item/clothing/head/helmet/space/hardsuit/power_armor/x02
*/

/* Hellfire/X03, needs sprite
/obj/item/clothing/head/helmet/space/hardsuit/power_armor/x03
...
/obj/item/clothing/suit/space/hardsuit/power_armor/x03
	name = "Hellfire Power Armor Suit"
	desc = ""
  armor = list(MELEE = 90, BULLET = 90, LASER = 90, ENERGY = 90, BOMB = 90, BIO = 100, RAD = 100, FIRE = 100, ACID = 100)	
  icon = ''
  worn_icon = ''
	icon_state = ""
	worn_icon_state = ""
helmettype = /obj/item/clothing/head/helmet/space/hardsuit/power_armor/x03
*/
