...
/obj/item/clothing/head/helmet/space/hardsuit/falloutpower_armor/t45
	...
	hardsuit_type = "t45" //Determines used sprites: hardsuit[on]-[type]
	light_range = 4.20
	light_power = 0.9
	light_color = "#d1c58d"
	max_integrity = 380
...
/obj/item/clothing/head/helmet/space/hardsuit/falloutpower_armor/t60
	...
	hardsuit_type = "t60" //Determines used sprites: hardsuit[on]-[type]
	light_range = 4.20
	light_power = 0.9
	light_color = "#d1c58d"
	max_integrity = 380
	radiotype = /obj/item/radio/headset/ms13/powerarmor/t60
	subarmor = list(SUBARMOR_FLAGS = NONE, \
                EDGE_PROTECTION = CLASS4_EDGE, \
                CRUSHING = CLASS5_CRUSH, \
                CUTTING = CLASS5_CUT, \
...
/obj/item/clothing/head/helmet/space/hardsuit/falloutpower_armor/x01
	...
	hardsuit_type = "x01" //Determines used sprites: hardsuit[on]-[type]
	light_range = 4.20
	light_power = 0.9
	light_color = "#d1c58d"
	max_integrity = 380
	radiotype = /obj/item/radio/headset/ms13/powerarmor/x01
	subarmor = list(SUBARMOR_FLAGS = NONE, \
                EDGE_PROTECTION = CLASS4_EDGE, \
                CRUSHING = CLASS5_CRUSH, \
                CUTTING = CLASS5_CUT, \
...
/obj/item/clothing/head/helmet/space/hardsuit/fallout/power_armor/x02
	...
	hardsuit_type = "x02" //Determines used sprites: hardsuit[on]-[type]
	light_range = 4.20
	light_power = 0.9
	light_color = "#d1c58d"
	max_integrity = 380
...
/obj/item/clothing/head/helmet/space/hardsuit/fallout/power_armor/x03
	...
	hardsuit_type = "x03" //Determines used sprites: hardsuit[on]-[type]
	light_range = 4.20
	light_power = 0.9
	light_color = "#d1c58d"
	max_integrity = 380
	radiotype = /obj/item/radio/headset/ms13/powerarmor/x03
	subarmor = list(SUBARMOR_FLAGS = NONE, \
                EDGE_PROTECTION = CLASS4_EDGE, \
                CRUSHING = CLASS5_CRUSH, \
                CUTTING = CLASS5_CUT, \
