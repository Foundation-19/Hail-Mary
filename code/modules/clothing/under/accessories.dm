...
// ==================== Merged from fallout (code\modules\fallout\code\modules\clothing\under\accessories.dm) ====================
/obj/item/clothing/accessory/patch
	name = "chest patch"
	desc = "A generic chest patch with sleek, six-pointed star on it."
	icon = 'icons/obj/clothing/accessories_f13.dmi'
	icon_state = "chestpatch"
	mob_overlay_icon = 'icons/mob/clothing/accessories_f13.dmi'
	above_suit = TRUE
