...
// ==================== Merged from fallout (code\modules\fallout\code\modules\clothing\masks\gasmask.dm) ====================
/*
Just leaving this here for quick copy-pasting, for future contributors.
	icon = 'icons/obj/clothing/masks_f13.dmi'
	mob_overlay_icon = 'icons/mob/clothing/mask_f13.dmi'
