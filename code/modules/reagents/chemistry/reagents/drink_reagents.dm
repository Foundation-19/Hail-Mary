...
/datum/reagent/consumable/shirley_temple
	name = "Shirley Temple"
	description = "Here you go, now you can drink like the californians."
	color = "#F43724"
	quality = DRINK_GOOD
...
/datum/reagent/consumable/agua_fresca
	name = "Agua Fresca"
	description = "A refreshing watermelon agua fresca. Perfect on a day at the beach."
	color = "#D25B66"
	quality = DRINK_VERYGOOD
...
// ==================== Merged from fallout (code\modules\fallout\reagents\drinks.dm) ====================
...
// ==================== Merged from fallout (code\modules\fallout\reagents\juices.dm) ====================
...
// ==================== Merged from fallout (code\modules\fallout\reagents\teas.dm) ====================
//fallout teas
