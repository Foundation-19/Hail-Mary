...
TYPE_PROC_REF(/client, asset_cache_confirm_arrival)(job_id)
...
TYPE_PROC_REF(/client, asset_cache_preload_data)(data)
	var/json = data
...
TYPE_PROC_REF(/client, asset_cache_update_json)()
...
TYPE_PROC_REF(/client, browse_queue_flush)(timeout = 50)
