...
TYPE_PROC_REF(/datum/ductnet, add_duct)(obj/machinery/duct/D)
	if(!D || (D in ducts))
		return
	ducts += D
	D.duct = src
...
TYPE_PROC_REF(/datum/ductnet, remove_duct)(obj/machinery/duct/ducting)
...
TYPE_PROC_REF(/datum/ductnet, add_plumber)(datum/component/plumbing/P, dir)
...
TYPE_PROC_REF(/datum/ductnet, remove_plumber)(datum/component/plumbing/P)
...
TYPE_PROC_REF(/datum/ductnet, assimilate)(datum/ductnet/D)
	ducts.Add(D.ducts)
...
TYPE_PROC_REF(/datum/ductnet, destroy_network)(delete=TRUE)
