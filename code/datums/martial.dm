...
TYPE_PROC_REF(/datum/martial_art, add_to_streak)(element,mob/living/carbon/human/D)
	if(D != current_target)
		current_target = D
		streak = ""
		restraining = 0
...
TYPE_PROC_REF(/datum/martial_art, basic_hit)(mob/living/carbon/human/A,mob/living/carbon/human/D)
...
TYPE_PROC_REF(/datum/martial_art, teach)(mob/living/carbon/human/H,make_temporary=0)
	if(!istype(H) || !H.mind)
		return FALSE
