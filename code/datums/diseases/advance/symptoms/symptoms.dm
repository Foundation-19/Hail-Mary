...
TYPE_PROC_REF(/datum/symptom, Start)(datum/disease/advance/A)
	if(neutered)
		return FALSE
...
TYPE_PROC_REF(/datum/symptom, End)(datum/disease/advance/A)
	if(neutered)
		return FALSE
	return TRUE

TYPE_PROC_REF(/datum/symptom, Activate)(datum/disease/advance/A)
	if(neutered)
		return FALSE
...
TYPE_PROC_REF(/datum/symptom, on_stage_change)(new_stage, datum/disease/advance/A)
	if(neutered)
		return FALSE
	return TRUE

TYPE_PROC_REF(/datum/symptom, Copy)()
...
TYPE_PROC_REF(/datum/symptom, generate_threshold_desc)()
	return

TYPE_PROC_REF(/datum/symptom, OnAdd)(datum/disease/advance/A)		//Overload when a symptom needs to be active before processing, like changing biotypes.
	return

TYPE_PROC_REF(/datum/symptom, OnRemove)(datum/disease/advance/A)	//But dont forget to remove them too.
	return
