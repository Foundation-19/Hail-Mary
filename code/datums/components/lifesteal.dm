...
TYPE_PROC_REF(/datum/component/lifesteal, item_afterattack)(obj/item/source, atom/target, mob/user, proximity_flag, click_parameters)
	if(!proximity_flag)
		return
	do_lifesteal(user, target)

TYPE_PROC_REF(/datum/component/lifesteal, hostile_attackingtarget)(mob/living/simple_animal/hostile/attacker, atom/target)
	do_lifesteal(attacker, target)

TYPE_PROC_REF(/datum/component/lifesteal, projectile_hit)(atom/fired_from, atom/movable/firer, atom/target, Angle)
	do_lifesteal(firer, target)

TYPE_PROC_REF(/datum/component/lifesteal, do_lifesteal)(atom/heal_target, atom/damage_target)
