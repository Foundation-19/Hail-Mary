...
/datum/component/decal/blood/Initialize(_icon, _icon_state, _dir, _cleanable=CLEAN_WEAK, _color, _layer=ABOVE_OBJ_LAYER)
	if(!isitem(parent))
...
TYPE_PROC_REF(/datum/component/decal/blood, get_examine_name)(mob/user, list/override)
	var/atom/A = parent
