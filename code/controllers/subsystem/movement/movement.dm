...
TYPE_PROC_REF(/datum/controller/subsystem/movement, pour_bucket)(list/bucket_info)
...
TYPE_PROC_REF(/datum/controller/subsystem/movement, smash_bucket)(index, bucket_time)
...
TYPE_PROC_REF(/datum/controller/subsystem/movement, queue_loop)(datum/move_loop/loop)
...
TYPE_PROC_REF(/datum/controller/subsystem/movement, dequeue_loop)(datum/move_loop/loop)
...
TYPE_PROC_REF(/datum/controller/subsystem/movement, add_loop)(datum/move_loop/add)
	add.start_loop()
	if(QDELETED(add))
		return
	queue_loop(add)

TYPE_PROC_REF(/datum/controller/subsystem/movement, remove_loop)(datum/move_loop/remove)
	dequeue_loop(remove)
	remove.stop_loop()
