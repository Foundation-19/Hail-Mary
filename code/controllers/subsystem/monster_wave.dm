...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, spawn_monsterwave)()
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, ghoul_wave)()
...
/*
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, deathclaw_wave)()
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, radscorpion_wave)()
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, fireant_wave)()
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, molerat_wave)()
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, mirelurk_wave)()
	var/spawn_amount = CEILING(GLOB.player_list.len / 10, 1)
	var/turf/choose_turf = quick_safe_turf()
	var/turf/pixel_turf = get_turf_pixel(choose_turf)
	for(var/i in 1 to spawn_amount)
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, gecko_wave)()
	var/spawn_amount = CEILING(GLOB.player_list.len / 5, 1)
	var/turf/choose_turf = quick_safe_turf()
	var/turf/pixel_turf = get_turf_pixel(choose_turf)
	for(var/i in 1 to spawn_amount)
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, cazador_wave)()
	var/spawn_amount = CEILING(GLOB.player_list.len / 5, 1)
	var/turf/choose_turf = quick_safe_turf()
	var/turf/pixel_turf = get_turf_pixel(choose_turf)
	for(var/i in 1 to spawn_amount)
...
TYPE_PROC_REF(/datum/controller/subsystem/monster_wave, wolf_wave)()
	var/spawn_amount = CEILING(GLOB.player_list.len / 5, 1)
	var/turf/choose_turf = quick_safe_turf()
	var/turf/pixel_turf = get_turf_pixel(choose_turf)
	for(var/i in 1 to spawn_amount)
